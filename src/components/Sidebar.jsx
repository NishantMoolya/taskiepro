...
const Sidebar = () => {
    return (
        <div className='pl-2 py-2 hidden sm:block flex-[0.2] h-screen'>
            <ul className='bg-white border rounded-xl flex flex-col gap-1 p-3 h-1/2 font-semibold text-sm text-slate-900'>
